...
<section id="PersonalTraining">
    <div class="container">
        ...
        <div class="row spacer-l">
            ...
            <p class="text-muted">例えば軽負荷有酸素運動にて、「最大心拍数の 30%で 30 分、週 1 回を 3 ヵ月行うことによ り、血管の幅が 1.0
                mm、内壁の厚さ(内壁の厚さが動脈硬化と言われています)が 0.2 mm改 善した」等を、エコーや心電図、脳波などを用いて定量化することで、軽負荷有酸素運動と
                いう運動療法が身体に与えた影響を可視化することが可能です。</p>
        </div>
        <div class="row spacer-l">
